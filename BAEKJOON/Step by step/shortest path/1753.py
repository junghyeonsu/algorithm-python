...
# def roof(startPoint, endPoint, W):
#     for k in data:
#         lineStart = int(k[0])
#         lineEnd = int(k[1])
#         lineW = int(k[2])
        
#         if startPoint == lineStart and endPoint == lineEnd:
#             shortest = int(W) + int(lineW)
#             weightList.append(shortest)
#             continue
#         elif startPoint == lineStart and endPoint != lineEnd:
#             shortest = int(W) + int(lineW)
#             roof(lineEnd, endPoint, lineW)
#         else:
#             continue
